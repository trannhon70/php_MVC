		...
		<div class="header_top">
			...
			<div class="header_top_right">
				<div class="search_box">
					<form action="search.php" method="post">
						<input style="padding: 8px 8px; " type="text" placeholder="Tìm kiếm sản phẩm" name="tukhoa">
						<input style="height:37px;" type="submit" name="search_product" value="Tìm kiếm">
					</form>
				</div>
			...
			<div class="menu">
				<ul id="dc_mega-menu-orange" class="dc_mm-orange">
					...
					$login_check = Session::get('customer_login');
					if ($login_check == true) {
						echo '<li><a href="wishlist.php">SP yêu thích</a> </li>';
					}
					?>
					<?php
